...
SpreadSheet::SpreadSheet(const SpreadSheet& rhv) : rowcnt {rhv.rowcnt}, colcnt {rhv.colcnt}, board {new Cell*[rowcnt]}
{
    for (int i = 0; i < rowcnt; ++i){
        board[i] = new Cell[colcnt];
    }
...
SpreadSheet::SpreadSheet(SpreadSheet&& rhv) : rowcnt {rhv.rowcnt}, colcnt {rhv.colcnt}, board {new Cell*[rowcnt]}
{
    for (int i = 0; i < rowcnt; ++i){
        board[i] = new Cell[colcnt];
    }
...
SpreadSheet::SpreadSheet(size_t size) : rowcnt {size}, colcnt {size}, board {new Cell*[rowcnt]}
{
    for (int i = 0; i < rowcnt; ++i){
        board[i] = new Cell[colcnt];
    }
...
SpreadSheet::SpreadSheet(size_t row, size_t col) : rowcnt {row}, colcnt {col}, board {new Cell*[rowcnt]}
{
    for (int i = 0; i < rowcnt; ++i){
        board[i] = new Cell[colcnt];
    }
